...
| `AJ CV/resume.tex` | User LaTeX CV template |
| `AJ CV/resume.cls` | User LaTeX class |
| `generate-pdf-latex.mjs` | LaTeX to PDF |
...
- "Change the CV template design" → edit `templates/cv-template.html` or `AJ CV/resume.tex`
...
- Node.js (mjs modules), Playwright (PDF + scraping), LaTeX (AJ CV option), YAML (config), HTML/CSS (template), Markdown (data)
